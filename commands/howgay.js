module.exports = {
    ...
    execute(message, args, Discord) {
        ...
        if (!Troll)
        {
            ...
            else if (howgay < 40) comment = "More straight than a banana, that's for sure.";
            else if (howgay < 50) comment = "You are somewhat gay. No need to thank for a professional diagnosis.";

module.exports = {
	...
	execute(message, args) {
		...
		return message.reply(kifo.embed("This command need `MANAGE_CHANNELS` permissions to work properly."));

		if (!message.guild.me.permissionsIn(message.channel).has("MANAGE_MESSAGES"))
		return message.reply(kifo.embed("This command need `MANAGE_MESSAGES` permissions to work properly."));

module.exports = {
	...
	execute(message, args, Discord) {
		...
		As harsh as it sounds, making the bot *costs* a lot of time and money ||electricity, coding knowledge, etc.||, and that's why I have decided to make this a **premium** feature.\n\n\

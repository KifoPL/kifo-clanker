module.exports = {
    ...
    execute(message, args) {
        let reply = "I honestly don't even know where to start, but what you're doing is incredibly annoying, needless, and generally speaking, stupid. Continuing to do so may result in permanent damage to your brain cells. As I care for your health, please stop doing this.";

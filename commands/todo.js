module.exports = {
    ...
    execute(message, args, Discord)
    {
		...
		.setAuthor("TODO", message.guild?.me?.user?.avatarURL({format: "png", dynamic: true, size: 64}), "https://github.com/KifoPL/kifo-clanker/")
		.setDescription(`React with <a:done:828097348545544202> to mark it as done!`)
		.setColor(`a039a0`)
		.setFooter(`Created at: ${Now.toUTCString()}`);
        message.author.send(Embed).then(message1 => {
